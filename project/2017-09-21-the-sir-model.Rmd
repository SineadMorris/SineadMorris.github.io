...
![Flow diagram of the SIR model with births equal to deaths.](/img/Precept1.pdf){ width=50% }
...
![Flow diagram of the SIR model with births equal to deaths.](/img/Precept1vacc.pdf){ width=40% }

```{r SIRvaccpic, echo = FALSE, message = FALSE, fig.width = 20, fig.height = 10}
knitr::include_graphics("../../img/Precept1vacc.pdf")
```
