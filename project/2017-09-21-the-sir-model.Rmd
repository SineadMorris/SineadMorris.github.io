...
output:
    blogdown::html_page:
        fig_width: 12
        fig_height: 5
        featuredImage: '/headers/Precept1.png'
---
...
![Flow diagram of the SIR model with births equal to deaths.](/img/Precept1.png)
...
![Flow diagram of the SIR model with births equal to deaths.](/img/Precept1vacc.png){ width=90% }
...
<iframe src="https://sineadmorris.shinyapps.io/sirmodel/" width="700" height="800"></iframe>