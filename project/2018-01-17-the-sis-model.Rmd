...
![SIS model extended to humans and mosquitos. Note that in contrast to the human population, which recover at rate $\gamma_h$, we assume that mosquitos do not recover from disease, and instead die at rate $\gamma_m$.\label{fig:SISm}](/img/SISm.png)
